...
DefaultTableModel defTableModel = new DefaultTableModel();
   defTableModel.setColumnIdentifiers(columnNames); //columns (model)
Object[] newRowData = {5,5,5,5};//plain data
defTableModel.addRow(newRowData);//data (model)
testTable.setModel(defTableModel);
